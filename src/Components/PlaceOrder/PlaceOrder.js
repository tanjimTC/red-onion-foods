            ...
            <div className="row align-items-center">
                <div className="col-md-8 col-xs-6">
                    <div className="place-order-left p-4">
                        <img className='img-fluid p-3' src={require('../../Image/ordercomplete.png')} alt=""/>
                    </div>
                </div>
                <div className="col-md-4 col-xs-6 p-4">
                    ...
                    <div className="location d-flex row">
                        <div className="your-pic col-md-4">
                            <img className='img-fluid' src={require('../../Image/Group 1152.png')} alt=""/>
                        </div>
                        <div className="your-name col-md-8">
                        {auth.currentUser?(
                           <p>{auth.currentUser.name} <br/>please wait  <img src="https://cdn3.iconfinder.com/data/icons/objects/512/Smiley-16.png" alt=""/></p>
                       ):(
                       <p>loading name...</p>
                       )}
                        </div>
