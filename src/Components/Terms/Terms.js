...
const Terms = () => {
  window.scrollTo(0, 0);
  return (
    <div className="container my-5 terms">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to red onion foods!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of red onion foods's Website, located at red onion foods.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use red onion foods if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing red onion foods, you agreed
        to use cookies in agreement with the red onion foods's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, red onion foods and/or its licensors own the
        intellectual property rights for all material on red onion foods. All
        intellectual property rights are reserved. You may access this from red
        onion foods for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ol>
        <li>Republish material from red onion foods</li>
        <li>Sell, rent or sub-license material from red onion foods</li>
        <li>Reproduce, duplicate or copy material from red onion foods</li>
        <li>Redistribute content from red onion foods</li>
      </ol>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. red
        onion foods does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of red onion foods,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, red onion foods
      ...
      <p>
        red onion foods reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant red onion foods a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of red onion foods; and (d) the
      ...
      <p>
        ...
        e-mail to red onion foods. Please include your name, your organization
      ...
      <p>
        No use of red onion foods's logo or other artwork will be allowed for
